...
class StringHelper {
  static extractXPathParts(xpath: string): XPathParts {
...
class HtmlHelper {
  static getInputValue(elementId: string) {
...
//   }
  ...
  static setInputValue(elementId: string, value: string) {
    const element = <HTMLInputElement>document.getElementById(elementId);
    if (element) {
      element.value = value;
    }
...
//   static parseId() {
//     let value = HtmlHelper.getInputValue('userId');
//     if (/[^\D+](\d*)[^\D+]/g.test(value)) {
//       let res = value.match(/[^\D+](\d*)[^\D+]/g);
//       if (res) {
//         return String(parseInt(res[0]));
//       }
//     }
//     return false;
//   }

//   static setSpanColor(elementId: string, color: string) {
//     const element = <HTMLSpanElement>document.getElementById(elementId);
//     if (color == 'green') {
//       element.setAttribute('class', 'input-group-text bg-success text-light');
//     } else if (color == 'red') {
//       element.setAttribute('class', 'input-group-text bg-danger text-light');
//     } else {
//       element.setAttribute('class', 'input-group-text');
//     }
//   }

//   static setInputlaceholder(elementId: string, value: string) {
//     const element = <HTMLInputElement>document.getElementById(elementId);
//     element.setAttribute('placeholder', value);
//   }

//   static setUserIdPlaceholder(value: string) {
//     const element = <HTMLInputElement>document.getElementById('userId');
//     element.setAttribute('placeholder', value);
//   }

//   static isValidEmail(email: string) {
//     let res = /.+@.+\..+/g.test(email);
//     return res;
//   }
}
...
class PopupStateHelper {
  ...
  //   return false;
  // }
  static async setStoredInput(inputId: string, text: string) {
    if (inputId == 'input') {
  ...
  static getStoredInput(inputId: string) {
    if (inputId == 'input') {
  ...
  static async copyStoredInput(from: string, to: string) {
    await this.setStoredInput(to, this.getStoredInput(from));
  }

  static async swapStoredInput(from: string, to: string) {
  ...
  static async saveToStorage(key: string, value: string): Promise<void> {
